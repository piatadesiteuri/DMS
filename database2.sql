...
--
-- Host: localhost    Database: digital_documents_db
-- ------------------------------------------------------
...
INSERT INTO `document_log` VALUES (1,6,'john_report.pdf',7,'2025-03-21 14:30:44'),(2,6,'hak.pdf',20,'2025-03-21 14:42:50'),(3,6,'sample_report.pdf',1,'2025-03-21 14:30:36'),(4,6,'shared_document.pdf',1,'2025-03-21 14:30:42');
...
INSERT INTO `sessions` VALUES ('19xoI9QLg6pG-qswH3Sl0bALLmQZK7Ln',1742639157,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2025-03-22T10:25:46.786Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"id_user\":6,\"nom\":\"Doe\",\"prenom\":\"John\",\"role\":\"user\"}'),('EGfmJLJoB-LufKyLgDT0XjudSnGAg99A',1742654599,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2025-03-22T12:18:23.595Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"id_user\":6,\"nom\":\"Doe\",\"prenom\":\"John\",\"role\":\"user\"}'),('n1Tuv1yWFiOc84HlTssZoKs6TIrJKkA9',1742639078,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2025-03-22T09:26:36.068Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\",\"sameSite\":\"lax\"},\"id_user\":6,\"nom\":\"Doe\",\"prenom\":\"John\",\"role\":\"user\"}');
...
INSERT INTO `table_mot_cle` VALUES (1,1,'annual','report','finance','summary','data'),(2,2,'strategy','business','planning','forecast','goals'),(3,3,'report','john','document','test','example');
...
INSERT INTO `table_previlege` VALUES (1,14,'sample_report.pdf',1,1,1,1),(2,15,'sample_report.pdf',1,1,1,1),(3,14,'business_plan.pdf',1,1,1,1),(4,15,'business_plan.pdf',1,0,1,0),(5,6,'john_report.pdf',1,1,1,1),(6,6,'shared_document.pdf',1,1,1,1),(7,6,'redaction_scientifique_.pdf',1,1,1,1),(8,6,'redaction_scientifique_.pdf',1,1,1,1);
...
--
-- Table structure for document versions
--
...
CREATE TABLE `document_versions` (
  ...
  CONSTRAINT `document_versions_ibfk_1` FOREIGN KEY (`id_document`) REFERENCES `table_document` (`id_document`) ON DELETE CASCADE,
  CONSTRAINT `document_versions_ibfk_2` FOREIGN KEY (`uploaded_by`) REFERENCES `user` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Table structure for document-tag relationships
...
-- Dump completed on 2025-03-21 16:51:18
